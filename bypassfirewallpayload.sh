...
cat logo.txt
printf "
                                                          \e[189m\e[1;99m<<<<<<< bypass firewall payload (FUD=full undeactive payload) >>>>>>>\e[0m\n"
printf "                                                         ++++++++ V1.0 Created by ...... abhi +++++++++++"



printf "                       welcome to bypass firewall payload                                                                                                                                                                                                                                                                                                                \e[189m\e[1;99m WELCOME TO IGNITETCH FUD TOOL \e[0m\n"
sleep 10
